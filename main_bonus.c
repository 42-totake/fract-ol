...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/07/23 15:46:24 by totake            #+#    #+#             */
/*   Updated: 2025/07/23 15:46:30 by totake           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	perse_args(int argc, char **argv)
{
	...
	fractol_type = 0;
	if (argc != 2 && argc != 4)
		handle_errors("Invalid number of arguments.", NULL);
		...
		handle_errors("Invalid fractal name rule.", NULL);
	return (fractol_type);
}
